...
const Approach = () => (
  <div className="min-h-screen pt-32">
    <section className="section-padding">
      <div className="max-w-3xl mx-auto">
        <ScrollReveal>
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-amber-950 mb-8">My Approach</h1>
        </ScrollReveal>
        <ScrollReveal delay={0.1}>
          <p className="text-xl md:text-2xl font-serif font-semibold text-amber-900/90 italic mb-12">
            This work is gentle, grounded, and human.
          </p>
        </ScrollReveal>

        <ScrollReveal delay={0.15}>
          <p className="text-base md:text-lg font-sans font-medium text-amber-950/90 leading-relaxed mb-12">
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-sm md:text-base font-sans font-bold uppercase tracking-[0.2em] text-amber-900 mb-6">Our work together focuses on</p>
        </ScrollReveal>
          ...
          {approachItems.map((item, i) => (
            <ScrollReveal key={i} delay={0.25 + i * 0.08}>
              <div className="glass-card p-5 flex items-center gap-4">
                ...
                <p className="text-base md:text-lg font-sans font-medium text-amber-950/90">{item}</p>
              </div>
            </ScrollReveal>
          ))}
        </div>
        ...
        <ScrollReveal delay={0.5}>
          <div className="border-l-4 border-amber-800/40 pl-8 py-4">
            <p className="text-lg md:text-xl font-serif font-semibold text-amber-900/90 italic leading-relaxed">
    ...
    <section className="section-padding bg-fog/30">
      <div className="max-w-3xl mx-auto">
        <ScrollReveal>
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-amber-950 mb-10">
          ...
          {[
            ...
            <ScrollReveal key={item.title} delay={i * 0.1}>
              <div className="glass-card-hover p-8 h-full border-t-4 border-amber-800/30">
                <h3 className="font-serif text-xl md:text-2xl font-bold text-amber-950 mb-4">{item.title}</h3>
                <p className="text-sm md:text-base font-sans font-medium text-amber-900/80 leading-relaxed">{item.desc}</p>
              </div>
            </ScrollReveal>
          ))}
        </div>
