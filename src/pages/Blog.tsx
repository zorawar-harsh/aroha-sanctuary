      ...
      <article className="max-w-4xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-12">
            <p className="text-sm md:text-base font-sans font-bold uppercase tracking-[0.2em] text-[#52191F] mb-6 flex items-center justify-center gap-2">
              <BookOpen size={16} /> Reflections
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-[#52191F] mb-8 leading-tight">
        ...
        <div className="max-w-2xl mx-auto prose prose-lg prose-headings:font-serif prose-headings:text-[#52191F] prose-p:text-[#52191F]/80 prose-p:leading-relaxed prose-p:font-serif prose-a:text-[#52191F]">
          
          <ScrollReveal delay={0.3}>
            <p className="text-xl md:text-2xl text-[#52191F] italic font-serif leading-relaxed mb-10 text-center">
              "There are phases in life when, even though you're trying your best, nothing seems to move."
            </p>

            <p className="text-lg md:text-xl font-serif text-[#52191F]/90 leading-relaxed mb-6">
            ...
            <ul className="list-disc pl-6 mb-8 text-[#52191F]/80 font-serif text-lg">
            ...
            <p className="text-lg md:text-xl font-serif text-[#52191F]/90 leading-relaxed mb-12">
          ...
          <ScrollReveal delay={0.1}>
            ...
            <p className="text-lg font-serif text-[#52191F]/90 mb-8">
            ...
            <div className="bg-[#E8E1D5]/30 p-8 rounded-2xl border-l-4 border-[#b37e73] mb-12">
              <p className="text-xl italic text-[#52191F] font-serif m-0">
          ...
          <ScrollReveal delay={0.1}>
            ...
            <p className="text-lg font-serif text-[#52191F]/90 mb-6">It doesn't have to be something big. It could be as simple as:</p>
            <ul className="list-none space-y-4 mb-10 text-lg font-serif text-[#52191F]/90">
          ...
          <ScrollReveal delay={0.1}>
            ...
            <p className="text-xl italic font-bold text-[#52191F] mb-6 font-serif text-center">
              "Maybe this phase had a purpose."
            </p>
            <p className="text-lg font-serif text-[#52191F]/90 mb-10 text-center">
            ...
            <div className="flex flex-col md:flex-row gap-6 my-12">
              <div className="flex-1 bg-white/40 p-8 rounded-2xl border border-rose-200/40 text-center">
                <p className="text-xs font-sans uppercase tracking-widest text-[#52191F]/60 mb-4">Instead of feeling...</p>
                <p className="text-[#52191F] font-bold font-serif text-xl">"I wasted that phase…"</p>
              </div>
              <div className="flex-1 bg-white/80 p-8 rounded-2xl border border-[#b37e73]/30 shadow-md transform md:-translate-y-2 text-center">
                <p className="text-xs font-sans uppercase tracking-widest text-[#52191F]/60 mb-4">You may feel...</p>
                <p className="text-[#52191F] font-bold font-serif text-xl">"That time changed me in ways I didn't understand back then."</p>
              </div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.2}>
            <div className="mt-20 p-12 bg-white/60 backdrop-blur-md rounded-[2rem] text-center shadow-lg border border-[#b37e73]/30 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <p className="text-2xl text-[#52191F] font-serif mb-8 leading-relaxed italic">
                  If you feel like talking things through, you're welcome to explore a one-on-one session in a calm and confidential space.
                </p>
                <Link
                  to="/connect"
                  className="inline-block bg-[#52191F] text-[#F1E4D1] px-10 py-4 rounded-full font-sans font-semibold tracking-wide transition-all shadow-md hover:shadow-xl hover:bg-[#3d1118] hover:-translate-y-0.5"
                >
                  Book a Session
                </Link>
              </div>
