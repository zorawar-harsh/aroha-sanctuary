      ...
      <article className="max-w-4xl mx-auto">
        ...
        <ScrollReveal>
          <div className="text-center mb-12">
            <p className="text-xl font-sans font-bold uppercase tracking-[0.2em] text-[#52191F] mb-6 flex items-center justify-center gap-2">
              <BookOpen size={16} /> Reflections
            </p>
            <h1 className="text-5xl md:text-6xl font-serif font-bold text-[#52191F] mb-8 leading-tight">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <ScrollReveal delay={0.3}>
            <p className="text-3xl text-[#52191F] italic font-serif leading-relaxed mb-10 text-center">
              "There are phases in life when, even though you're trying your best, nothing seems to move."
            </p>

            <p className="text-xl font-serif text-[#52191F]/90 leading-relaxed mb-6">
            ...
            <ul className="list-disc pl-6 mb-8 text-[#52191F]/80 font-serif text-xl">
            ...
            <p className="text-xl font-serif text-[#52191F]/90 leading-relaxed mb-12">
          ...
          <ScrollReveal delay={0.1}>
            ...
            <p className="text-xl font-serif text-[#52191F]/90 mb-4">
          ...
          <ScrollReveal delay={0.1}>
            ...
            <p className="text-xl font-serif text-[#52191F]/90 mb-8">
          ...
          <ScrollReveal delay={0.1}>
            ...
            <p className="text-xl font-serif text-[#52191F]/90 mb-6">It doesn't have to be something big. It could be as simple as:</p>
            <ul className="list-none space-y-4 mb-10 font-serif text-xl text-[#52191F]/90">
          ...
          <ScrollReveal delay={0.1}>
            ...
            <p className="text-3xl italic font-bold text-[#52191F] mb-6 font-serif text-center">
              "Maybe this phase had a purpose."
            </p>
            <p className="text-xl font-serif text-[#52191F]/90 mb-10 text-center">
            ...
            <div className="flex flex-col md:flex-row gap-6 my-12">
              <div className="flex-1 bg-white/40 p-8 rounded-2xl border border-rose-200/40 text-center">
                <p className="text-xl font-sans uppercase tracking-widest text-[#52191F]/60 mb-4">Instead of feeling...</p>
                <p className="text-xl text-[#52191F] font-bold font-serif">"I wasted that phase…"</p>
              </div>
              <div className="flex-1 bg-white/80 p-8 rounded-2xl border border-[#b37e73]/30 shadow-md transform md:-translate-y-2 text-center">
                <p className="text-xl font-sans uppercase tracking-widest text-[#52191F]/60 mb-4">You may feel...</p>
                <p className="text-xl text-[#52191F] font-bold font-serif">"That time changed me in ways I didn't understand back then."</p>
              </div>
            </div>
          </ScrollReveal>
