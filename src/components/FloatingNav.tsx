      ...
      >
        <div className="mx-auto flex max-w-[2000px] items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <button
            ...
            className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-[#1f1d1c]/80 text-white transition hover:bg-[#1f1d1c] md:hidden"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="fixed inset-x-4 top-20 z-40 rounded-3xl bg-[#94294d]/95 border border-[#1f1d1c]/30 shadow-2xl p-4 md:hidden"
          >
